...
<html>
  ...
  <body>
    ...
    <div class="content">
      <div class="cards">
        <div class="card header" style="border-radius: 15px;">
            ...
            <button class='btn btn-outline-light btn-floating m-1' onclick="window.open('recordtable.php', '_blank');">Open Record Table</button>
    ...
    <div class="content">
      <div class="cards">
        <div class="card header" style="border-radius: 15px;">
            <button class='btn btn-outline-light btn-floating m-1' onclick="window.open('history.php', '_blank');">Open Graph History</button>
            <h3 style="font-size: 0.7rem;"></h3>
        </div>
      </div>
    </div>
