...
// Check if the form is submitted with filter dates
if (isset($_GET['year']) && isset($_GET['month'])) {
    $selectedYear = $_GET['year'];
    $selectedMonth = $_GET['month'];
} else {
    // If no filter dates are provided, set the selected year and month to the current year and month
...
<html>
  ...
  <body>
    ...
    <div class="forms">
        <form id="filter-form">
            ...
            <select id="year" name="year">
                <?php
                // Display a list of years for the dropdown
            ...
            <select id="month" name="month">
                <?php
                // Display a list of months for the dropdown
    ...
    <div id="calendar">
        <?php
        // Query the database to get the count of recorded data for each date within the selected range
        ...
        for ($day = 1; $day <= $daysInMonth; $day++) {
            ...
            // Find the record count for the current date
            ...
            // Display the calendar cell with the record count
